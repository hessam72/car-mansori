...
/**
 * Global PCSS enable. Mount this INSIDE <Canvas> and BEFORE the models stream
 * in — drei's SoftShadows swaps the global THREE.ShaderChunk shadow code, so
 * any material compiled before it mounts keeps hard shadows until it recompiles.
 */
